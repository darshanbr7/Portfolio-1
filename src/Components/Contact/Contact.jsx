            ...
            <div className="c-left">
                ...
                <div className="c-info">
                    <div className="c-info-item">
                        <img src={phone} alt="" className='c-icon' />+91 7483155065
                    </div>
                    <div className="c-info-item">
                        <img src={email} alt="" className='c-icon' />darshanbr007@gmail.com
                    </div>
                    <div className="c-info-item">
                        <img src={location} alt="" className='c-icon' />#119 Marattahalli Bengalore-560027.
                    </div>
                </div>
            </div>
